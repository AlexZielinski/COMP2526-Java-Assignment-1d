...
public class Main 
{
                               ...
                               final int stop)
    {
        ...
        {
            case "+":
                table = new Table(start, stop, new AdditionCalculator("+"));
                break;
            case "-":
                table = new Table(start, stop, new SubtractionCalculator("-"));
                break;
            case "*":
                table = new Table(start, stop, new MultiplicationCalculator("*"));
                break;
            case "/":
                table = new Table(start, stop, new DivisionCalculator("/"));
                break;
            default:
                System.err.println("Table type unknown");
                table = new Table(start, stop, new MultiplicationCalculator("*"));
                break;
        }
